...
Title "APPLYING DETECTOR"
  ...
  # PN
  python3 -W"ignore" $SCRIPTS/detector.py -path $DIR/$OBS -out $RESULTS/$OBS -bs $BS -dl $DL -tw $TW -gtr $GTR -mta $CPUS -inst PN --render
  # MOS 1
  python3 -W"ignore" $SCRIPTS/detector.py -path $DIR/$OBS -out $RESULTS/$OBS -bs $BS -dl $DL -tw $TW -gtr $GTR -mta $CPUS -inst M1 --render
  # MOS 2 
  python3 -W"ignore" $SCRIPTS/detector.py -path $DIR/$OBS -out $RESULTS/$OBS -bs $BS -dl $DL -tw $TW -gtr $GTR -mta $CPUS -inst M2 --render
